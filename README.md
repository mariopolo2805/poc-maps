...
### Ejemplo de prompts para Copilot
```markdown
<!-- Copilot: Genera un componente GoogleMapsProvider.tsx que inicialice react-google-maps con API Key y exponga contexto -->
<!-- Copilot: Genera un hook useMapProvider.ts que lea queryParam y devuelva el provider adecuado -->
<!-- Copilot: Genera MapContainer.tsx que muestre un mapa básico usando el provider activo -->
```

---

## Próximos pasos
- Añadir configuración de ESLint + Prettier.
- Documentar cómo extender la POC para otros proveedores.